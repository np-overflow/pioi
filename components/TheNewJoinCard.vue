...
<template>
	...
	>
		...
		>
			<div
				class="
				z-50 w-full join-card-content rounded-lg
				flex flex-col
				my-2
				xs:my-3 sm:my-4"
			>
...
<style scoped>
	.box {
		@apply relative flex justify-center items-center transition-all duration-500;
	}
