...
const goToWorkshopRegistration = () => {
	navigateTo('https://forms.office.com/r/rfr8st7m0X', {
		external: true,
	})
}
...
<style scoped>
	#hero {
		background: radial-gradient(ellipse 80% 50% at 50% -20%,rgba(200, 200, 200, 0.3), rgba(0, 0, 0, 0));
	}
</style>
